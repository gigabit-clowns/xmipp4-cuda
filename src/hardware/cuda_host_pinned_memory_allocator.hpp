...
class cuda_host_pinned_memory_allocator final
    : public cuda_memory_allocator
{
public:
    cuda_host_pinned_memory_allocator();
    cuda_host_pinned_memory_allocator(
        const cuda_host_pinned_memory_allocator &other
    ) = delete;
    cuda_host_pinned_memory_allocator(
        cuda_host_pinned_memory_allocator &&other
    ) = default;
    ~cuda_host_pinned_memory_allocator() override = default;

    cuda_host_pinned_memory_allocator&
    operator=(const cuda_host_pinned_memory_allocator &other) = delete;
    cuda_host_pinned_memory_allocator&
    operator=(cuda_host_pinned_memory_allocator &&other) = default;
